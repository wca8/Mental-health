  ...
  <div class="login">
    <div class="userInfo" v-if="$store.state.isToken">
      <div v-if="userInfo.avatarUrl">
        <img @click="userInfoClick" :src="userInfo.avatarUrl" alt="" />
      </div>
      <div v-else>
        <img
          @click="userInfoClick"
          src="https://dcdn.it120.cc/2021/06/13/fead149b-8be7-41f5-8f03-a098a0cfa46c.jpg"
          alt=""
        />
      </div>
      <el-row>
        <el-col :xs='0' :span="24">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="ControlCenterClick"
