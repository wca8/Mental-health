    ...
    <div class="main">
      ...
      <div v-show="isShowTextarea" ref="Textare" class="answer-the-questions">
       <div class="go-questions">
         ...
         <div @click="SubmitAnswerClick" class="Submit-answer"><el-button type="success" round>提交回答</el-button></div>
       </div>
...
.height0{
  animation: height0 .5s linear forwards;
}
.height0_{
  animation: height0_ .5s linear forwards;
}
</style>
<style>
