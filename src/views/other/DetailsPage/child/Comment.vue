  ...
  <div class="comment">
    <div class="main">
      ...
      <div class="submit">
        ...
        <user-comment v-for="item in commentList"  :comment-list="item"></user-comment>
...
export default {
  ...
  data(){
    return{
      circleUrl:"https://dcdn.it120.cc/2021/06/13/fead149b-8be7-41f5-8f03-a098a0cfa46c.jpg",
      textarea: '',
      commentList:[],
    }
  },
